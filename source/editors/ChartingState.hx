...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Shoot Rocket Launcher', "Bullet of The Rocket Launcher\n\n that heads towards Guest"],
		['Kill Guest', "Rip"],
		['Noob Up Alt Anim 1', ""],
		['Noob Up Alt Anim 2', ""],
		['Noob Up Alt Anim Reset', ""]
	];
	...
	public var nukeImage:FlxSprite;
	var nukeButton:FlxButton;
	...
	**/
	...
	override function create()
	{
		...
		nukeImage = new FlxSprite().loadGraphic(Paths.image('eminem'));
		nukeImage.scrollFactor.set();
		nukeImage.visible = false;
		add(nukeImage);

		nukeButton = new FlxButton(0, FlxG.height, "Nuke", function()
		{
			nukeGame();
		});
		
		nukeButton.y -= nukeButton.height;
	...
	public function nukeGame():Void
	{
		nukeImage.visible = true;
		remove(nukeButton);
		FlxG.sound.play(Paths.sound('vineboom'), 1, false, null, true, function()
		{
